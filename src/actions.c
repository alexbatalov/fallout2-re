...
{
    if (critter_flag_check(obj->pid, 0x4000)) {
        return -1;
    }
...
int pick_death(Object* attacker, Object* defender, Object* weapon, int damage, int anim, bool isFallingBack)
{
    ...
    if (critter_flag_check(defender->pid, 0x1000)) {
...
void show_damage_to_object(Object* a1, int damage, int flags, Object* weapon, bool isFallingBack, int knockbackDistance, int knockbackRotation, int a8, Object* a9, int a10)
{
    ...
    if (critter_flag_check(a1->pid, 0x4000)) {
        knockbackDistance = 0;
    }
    ...
    if (weapon != NULL) {
        if ((flags & DAM_EXPLODE) != 0) {
            reg_anim_11_1(a1, weapon, obj_drop, -1);
            fid = buildFid(5, 10, 0, 0, 0);
            ...
            reg_anim_11_1(a1, weapon, internal_destroy, -1);
    ...
    if ((flags & DAM_DEAD) != 0) {
        ...
        reg_anim_11_1(a1, (Object*)anim, (AnimationProc*)show_death, -1);
    }
}
...
int show_death(Object* obj, int anim)
{
    ...
    if (critter_flag_check(obj->pid, 2048) == 0) {
        obj->flags |= 0x10;
    ...
    if (anim >= 30 && anim <= 31 && critter_flag_check(obj->pid, 4096) == 0 && critter_flag_check(obj->pid, 64) == 0) {
...
// 0x4112B4
int action_melee(Attack* attack, int anim)
{
    int fid;
    Art* art;
...
// 0x411600
int action_ranged(Attack* attack, int anim)
{
    Object* neighboors[6];
        ...
        if ((attack->attackerFlags & DAM_HIT) != 0 || (attack->attackerFlags & DAM_CRITICAL) == 0) {
            ...
            if (protoGetProto(projectilePid, &projectileProto) != -1 && projectileProto->fid != -1) {
                if (anim == ANIM_THROW_ANIM) {
                    ...
                    int v46;
                    int v45;
                    intface_get_item_states(&v46, &v45);

                    itemRemove(attack->attacker, weapon, 1);
                    v50 = item_replace(attack->attacker, weapon, weaponFlags & 0x3000000);
                    ...
                    if (attack->attacker == gDude) {
                        ...
                        intface_update_items(false, v46, v45);
                    }
...
int action_climb_ladder(Object* a1, Object* a2)
{
    ...
    reg_anim_11_1(a1, a2, is_next_to, -1);
    reg_anim_set_rotation_to_tile(a1, a2->tile);
    reg_anim_11_1(a1, a2, check_scenery_ap_cost, -1);
...
int action_use_an_item_on_object(Object* a1, Object* a2, Object* a3)
{
    ...
    if (sceneryType != SCENERY_TYPE_LADDER_UP || a3 != NULL) {
        ...
        if (a3 == NULL) {
            reg_anim_11_0(a1, a2, check_scenery_ap_cost, -1);
        }
        ...
        if (v12 == OBJ_TYPE_CRITTER && critter_is_prone(a2)) {
        ...
        if (a3 != NULL) {
            ...
            reg_anim_12(a1, a2, a3, (AnimationProc2*)obj_use_item_on, -1);
        } else {
            reg_anim_11_0(a1, a2, obj_use, -1);
        }
...
{
    return action_use_an_item_on_object(a1, a2, NULL);
}
...
int actionPickUp(Object* critter, Object* item)
{
    ...
    reg_anim_11_1(critter, item, is_next_to, -1);
    reg_anim_11_0(critter, item, check_scenery_ap_cost, -1);
    ...
    if (itemProto->item.type != ITEM_TYPE_CONTAINER || proto_action_can_pickup(item->pid)) {
        ...
        reg_anim_11_0(critter, item, obj_pickup, actionFrame);
    } else {
        ...
        if (item->frame != 1) {
            reg_anim_11_0(critter, item, obj_use_container, actionFrame);
        }
...
int actionUseSkill(Object* a1, Object* a2, int skill)
{
    ...
    reg_anim_11_1(v1, a2, is_next_to, -1);

    int anim = (((a2->fid & 0xF000000) >> 24) == OBJ_TYPE_CRITTER && critter_is_prone(a2)) ? ANIM_MAGIC_HANDS_GROUND : ANIM_MAGIC_HANDS_MIDDLE;
    ...
    // TODO: Get rid of casts.
    reg_anim_12(v1, a2, (void*)skill, (AnimationProc2*)obj_use_skill_on, -1);
    return reg_anim_end();
}
...
int actionExplode(int tile, int elevation, int minDamage, int maxDamage, Object* a5, bool a6)
{
    ...
    if (a6) {
        ...
        reg_anim_11_1(explosion, 0, combat_explode_scenery, -1);
        ...
        // TODO: Get rid of casts.
        reg_anim_11_1((Object*)attack, a5, (AnimationProc*)report_explosion, -1);
        reg_anim_11_1(NULL, NULL, finished_explosion, -1);
        if (reg_anim_end() == -1) {
            dword_5106D0 = 0;
...
int actionTalk(Object* a1, Object* a2)
{
    ...
    reg_anim_11_1(a1, a2, can_talk_to, -1);
    reg_anim_11_0(a1, a2, talk_to, -1);
    return reg_anim_end();
}
...
void action_dmg(int tile, int elevation, int minDamage, int maxDamage, int damageType, bool animated, bool bypassArmor)
{
    ...
    Object* v9 = obj_blocking_at(NULL, tile, elevation);
    ...
    if (v9 != NULL) {
        ...
        if (bypassArmor) {
            ...
            damage = compute_dmg_damage(minDamage, maxDamage, v9, &(attack->defenderKnockback), damageType);
        }
    ...
    if (animated) {
        ...
        show_damage(attack, gMaximumBloodDeathAnimations[damageType], 0);
        // TODO: Get rid of casts.
        reg_anim_11_1((Object*)attack, NULL, (AnimationProc*)report_dmg, 0);
        reg_anim_hide(obj);
...
//
// 0x413660
int compute_dmg_damage(int min, int max, Object* obj, int* a4, int damageType)
{
    if (!critter_flag_check(obj->pid, 0x4000)) {
        a4 = NULL;
    }
...
{
    if (pathfinderFindPath(a1, a1->tile, a2->tile, NULL, 0, obj_sight_blocking_at) == 0) {
        return -1;
    }
