...
// 0x5195E0
MovieSetPaletteEntriesProc* gMovieSetPaletteEntriesProc = sub_4C7428;
...
int sub_486C80(int win, unsigned char* a2, int a3, int a4, int a5)
{
    ...
    // TODO: Incomplete.
    // sub_4BB7D8(a2, a3, a4, a5, off_638EAC, off_638EC0, buf + offset, windowGetWidth(win));
...
int sub_486D84(int win, int a2, int a3, int a4, int a5)
{
    ...
    // TODO: Incomplete.
    // sub_4BB3A8(buf + offset, dword_638E94, dword_638E84, windowGetWidth(win), a2, a3, a4, a5);
...
void movieInit()
{
    ...
    sub_4F4940(640, 480, 480, 0, 0, 0, 0, 0, 0);
...
{
    gMovieSetPaletteEntriesProc = proc != NULL ? proc : sub_4C7428;
}
...
int sub_487710(int win, char* filePath, int (*a3)())
{
    ...
    if ((gMovieFlags & MOVIE_EXTENDED_FLAG_0x04) != 0) {
        ...
        debugPrint("Buffered ");
        sub_4F4B90(a3);
        sub_4F49F0(movieBufferedImpl);
        v17 = 0;
        v16 = 0;
        v15 = 0;
    }

    sub_4F4BF0((int)gMovieFileStream, v15, v16, v17);
...
int sub_487AC8(int win, char* filePath)
{
    ...
    dword_638E80 = 0;
    return sub_487710(win, filePath, sub_486E08);
}
...
void movieSetVolume(int volume)
{
    if (gMovieDirectSoundInitialized) {
        int normalizedVolume = sub_4ADD68(volume);
