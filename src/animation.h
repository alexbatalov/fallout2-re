...
int anim_set_continue(int a1, int a2);
int anim_set_end(int a1);
...
int anim_move(Object* obj, int tile, int elev, int a3, int a4, int a5, int animationSequenceIndex);
int anim_move_straight_to_tile(Object* obj, int a2, int a3, int fid, int a5, int a6);
int anim_move_on_stairs(Object* obj, int a2, int a3, int fid, int a5);
int check_for_falling(Object* obj, int a2, int a3);
void object_move(int index);
void object_straight_move(int a1);
int anim_animate(Object* obj, int a2, int a3, int a4);
void object_animate();
...
int anim_change_fid(Object* obj, int a2, int fid);
void anim_stop();
