...
int sub_415B44(int a1, int a2);
int sub_415B9C(int a1);
int sub_415E24(Object* a1, Object* a2);
int sub_415EE8(Object* object, int from, int to, unsigned char* a4, int a5);
int pathfinderFindPath(Object* object, int from, int to, unsigned char* rotations, int a5, PathBuilderCallback* callback);
int sub_41633C(int a1, int a2, int a3, int a4);
...
int sub_416DFC(Object* obj, int tile, int elev, int a3, int a4, int a5, int animationSequenceIndex);
int sub_416F54(Object* obj, int a2, int a3, int fid, int a5, int a6);
int sub_41712C(Object* obj, int a2, int a3, int fid, int a5);
int sub_417248(Object* obj, int a2, int a3);
void sub_417360(int index);
void sub_4177C0(int a1);
int sub_4179B8(Object* obj, int a2, int a3, int a4);
void sub_417B30();
void sub_417F18();
...
int sub_418660(Object* obj, int a2, int fid);
void sub_4186CC();
