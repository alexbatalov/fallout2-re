...
void lipsTicker()
{
    ...
    if ((gLipsData.flags & LIPS_FLAG_0x02) != 0) {
        int v1 = sub_4AE634(gLipsData.sound);
...
int lipsStart()
{
    ...
    if (sub_4AE6CC(gLipsData.sound, gLipsData.field_20) != 0) {
...
int lipsLoad(const char* audioFileName, const char* headFileName)
{
    ...
    strcat(path, sub_47AAC0(gLipsData.field_50, sizeof(gLipsData.field_50)));
    strcat(path, ".");
...
int sub_47B5D0()
{
    ...
    char path[MAX_PATH];
    char* v1 = sub_47AAC0(gLipsData.field_50, sizeof(gLipsData.field_50));
