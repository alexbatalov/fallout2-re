...
extern const int dword_4BC860[ELEVATION_COUNT];
...
extern char byte_50EE44[];
extern char byte_50EE4C[];

extern const char* off_51DD88[2];
extern const char* off_51DD90[2];
extern const char* gEncounterFrequencyTypeKeys[ENCOUNTER_FREQUENCY_TYPE_COUNT];
extern const char* off_51DDB0[9];
extern const char* off_51DDD4[ENCOUNTER_SCENERY_TYPE_COUNT];
...
extern unsigned char* off_51DE34;
extern int dword_51DE38;
extern const char* off_51DE3C[ENCOUNTER_SITUATION_COUNT];
extern const char* off_51DE4C[ENCOUNTER_CONDITIONAL_OPERATOR_COUNT];
...
extern int dword_51DE9C;
extern unsigned int dword_51DEA0;
extern int dword_51DEA4;
extern int dword_51DEA8;
extern int dword_51DEAC;
extern unsigned int dword_51DEB0;
extern bool dword_51DEB4;
...
extern char* off_51DEC8[2];

extern int dword_672DB8[2];
extern int dword_672DC0[2];
extern int dword_672DC8[2];
extern int dword_672DD0[2];
extern int dword_672DD8[ENTRANCE_LIST_CAPACITY];
extern int dword_672E00;
extern int dword_672E04;
extern int dword_672E08;
extern int dword_672E0C;
extern int dword_672E10;
extern SubtileInfo* off_672E14;
...
extern int dword_672E38;
extern int dword_672E3C;
extern int dword_672E40;
extern int dword_672E44;
extern int dword_672E48;
extern int dword_672E4C;
extern int dword_672E50;
extern int dword_672E54;
extern int dword_672E58;
extern int dword_672E5C;
extern int dword_672E60;
extern bool gWorldmapIsInCar;
extern int dword_672E68;
...
extern int dword_672EFC;
extern int dword_672F00;
...
int wmParseEncounterSubEncStr(EncounterEntry* entry, char** str_ptr);
int wmParseFindSubEncTypeMatch(char* str, int* out_value);
int wmFindEncBaseTypeMatch(char* str, int* out_value);
int wmReadEncBaseType(char* str, int* out_value);
int wmParseEncBaseSubTypeStr(ENC_BASE_TYPE_38* ptr, char** str_ptr);
...
int wmParseTerrainTypes(Config* config, char* str);
...
int wmParseEncounterItemType(char** str_ptr, ENC_BASE_TYPE_38_48* a2, int* a3, const char* delim);
int wmParseItemType(char* str, ENC_BASE_TYPE_38_48* ptr);
...
int wmMapMarkVisited(int map_index);
int wmMatchEntranceFromMap(int cityIndex, int mapIndex, int* entranceIndexPtr);
int wmMatchEntranceElevFromMap(int a1, int a2, int a3, int* out_a4);
int wmMatchAreaFromMap(int a1, int* out_a2);
int wmMapMarkMapEntranceState(int a1, int a2, int a3);
void wmWorldMap();
...
bool wmEvalSubConditional(int a1, int a2, int a3);
bool wmGameTimeIncrement(int a1);
int wmGrabTileWalkMask(int tile_index);
...
int wmSubTileGetVisitedState(int a1, int a2, int* a3);
...
bool wmAreaIsKnown(int city_index);
int wmAreaVisitedState(int a1);
bool wmMapIsKnown(int map_index);
bool wmAreaMarkVisitedState(int a1, int a2);
bool wmAreaSetVisibleState(int a1, int a2, int a3);
...
int wmMakeTabsLabelList(int** out_cities, int* out_len);
...
int wmMatchAreaContainingMapIdx(int map_index, int* out_city_index);
int wmTeleportToArea(int a1);
