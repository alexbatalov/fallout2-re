...
int sub_4BDCA8(EncounterEntry* entry, char** str_ptr);
int sub_4BDE94(char* str, int* out_value);
int sub_4BDED8(char* str, int* out_value);
int sub_4BDF34(char* str, int* out_value);
int sub_4BE140(ENC_BASE_TYPE_38* ptr, char** str_ptr);
...
int sub_4BE414(Config* config, char* str);
...
int sub_4BE7A4(char** str_ptr, ENC_BASE_TYPE_38_48* a2, int* a3, const char* delim);
int sub_4BE888(char* str, ENC_BASE_TYPE_38_48* ptr);
...
bool sub_4BFAFC();
int sub_4BFB08(int map_index);
int sub_4BFB64(int cityIndex, int mapIndex, int* entranceIndexPtr);
int sub_4BFBE8(int a1, int a2, int a3, int* out_a4);
int sub_4BFC7C(int a1, int* out_a2);
int sub_4BFD50(int a1, int a2, int a3);
void sub_4BFE0C();
...
bool sub_4C1C0C(int a1, int a2, int a3);
bool sub_4C1C50(int a1);
int sub_4C1CE8(int tile_index);
...
int sub_4C3740(int a1, int a2, int* a3);
...
bool sub_4C453C(int city_index);
int sub_4C457C(int a1);
bool sub_4C45BC(int map_index);
bool sub_4C4634(int a1, int a2);
bool sub_4C46CC(int a1, int a2, int a3);
...
int sub_4C55D4(int** out_cities, int* out_len);
...
int sub_4C59A4(int map_index, int* out_city_index);
int sub_4C5A1C(int a1);
