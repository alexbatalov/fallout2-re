...
bool falloutInit(int argc, char** argv)
{
    ...
    if (selfrun_get_list(&off_5194DC, &dword_5194E0) == 0) {
        dword_5194E4 = 0;
    }
...
// 0x480D4C
int main_load_new(char* mapFileName)
{
    dword_5186CC = 0;
    dword_5194E8 = 0;
    gDude->flags &= ~(0x08);
...
void showDeath()
{
    ...
    if (win != -1) {
        do {
            ...
            dword_614838 = false;
            speechSetEndCallback(main_death_voiceover_callback);
