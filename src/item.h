...
bool can_use_weapon(Object* item_obj);
...
int insert_drug_effect(Object* critter_obj, Object* item_obj, int a3, int* stats, int* mods);
void perform_drug_effect(Object* critter_obj, int* stats, int* mods, bool is_immediate);
...
int insert_withdrawal(Object* obj, int a2, int a3, int a4, int a5);
