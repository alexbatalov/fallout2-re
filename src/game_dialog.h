...
void gdSetupFidget(int headFid, int reaction);
void gameDialogWaitForFidgetToComplete();
void gdPlayTransition(int a1);
void reply_arrow_up(int btn, int a2);
void reply_arrow_down(int btn, int a2);
void reply_arrow_restore(int btn, int a2);
...
void gdialog_scroll_subwin(int a1, int a2, unsigned char* a3, unsigned char* a4, unsigned char* a5, int a6, int a7);
...
int gdPickAIUpdateMsg(Object* obj);
int gdCanBarter();
