...
// 0x51EE08
void (*off_51EE08)(LPDIRECTDRAWSURFACE, int, int, int, int, int, int, int, int) = sub_4F4A00;
...
//
// 0x51EE14
void (*off_51EE14)(unsigned char*, int, int) = NULL;
...
int sub_4F4BF0(int fileHandle, int a2, int a3, char a4)
{
    ...
    if (!sub_4F4C90(fileHandle)) {
        sub_4F6240();
        return -8;
    }

    off_6B39DC = sub_4F4DA0();
    dword_6B39D0 = 0;
...
// 0x4F4C90
int sub_4F4C90(int stream)
{
    Mve* mve;

    off_6B39CC = stream;

    mve = sub_4F4D00(sizeof(Mve));
    if (mve == NULL) {
        return 0;
    }
...
void* sub_4F4D00(int size)
{
    ...
    buf = sub_4F4D40(&stru_6B3690, size);
    if (buf == NULL) {
        return NULL;
    }

    return gMovieLibReadProc(off_6B39CC, buf, size) < 1 ? NULL : buf;
}
...
unsigned char* sub_4F4DA0()
{
    ...
    buf = (unsigned char*)sub_4F4D00((dword_6B369C & 0xFFFF) + 4);
    if (buf == NULL) {
        return NULL;
    }

    dword_6B369C = *(int*)(buf + (dword_6B369C & 0xFFFF));
...
int sub_4F4E40()
{
    ...
    result = 0;
    if (dword_51EDE4) {
        if (((dword_6B3ADC + 1000 * timeGetTime()) & 0x80000000) != 0) {
            result = 1;
            while (((dword_6B3ADC + 1000 * timeGetTime()) & 0x80000000) != 0)
                ;
        }
        dword_6B3ADC += dword_6B3AD0;
    }
...
LABEL_5:
    ...
    while (1) {
        ...
        case 1:
            v0 = 0;
            v1 = (unsigned short*)sub_4F4DA0();
            goto LABEL_5;
        case 2:
            if (!sub_4F54F0(v1[0], v1[2])) {
                v6 = -3;
                break;
            }
            continue;
        case 3:
            ...
            if (sub_4F5570(v1[0], v8, v1[1] & 0x01, v1[2], (v1[1] & 0x02) >> 1, v7)) {
                continue;
            }
        ...
        case 5:
            ...
            if (!sub_4F5CB0(v1[0], v1[1], v10, v9)) {
                v6 = -5;
                break;
            }

            v11 = 4 * dword_6B3CFC / dword_51EBDC & 0xFFFFFFF0;
            if (dword_6B4027) {
                v11 >>= 1;
            }
            ...
            if (dword_6B402F + v13 > dword_6B36AC) {
                v6 = -6;
                break;
            }
        ...
        case 7:
            ...
            if (v21) {
                sub_4F6080(dword_6B39C0, dword_6B39C4, v21);
            } else if (!dword_51EDE8 || v1[1]) {
                sub_4F5F40(dword_6B39C0, dword_6B39C4, v18);
            } else {
                dword_51EDEC = 1;
                ++dword_6B3684;
            }
        ...
        case 11:
            ...
            sub_4F60F0(v1[0], v1[1], v1[2], v1[3], v1[4], v1[5]);
            continue;
        case 12:
            // palette
            sub_4F6210((unsigned char*)v1 + 4, v1[0], v1[1]);
            continue;
        case 14:
        ...
        case 17:
            ...
            if (dword_6B4027) {
                ...
                // TODO: Incomplete.
                assert(false);
                // sub_4F9F28(v3, v1[7], v1[2], v1[3], v1[4], v1[5]);
            ...
            if ((dword_51EBD8 & 3) == 1) {
                ...
                // TODO: Incomplete.
                assert(false);
                // sub_4F8DD4(v3, v1[7], v1[2], v1[3], v1[4], v1[5]);
            ...
            sub_4F7359((unsigned char*)v3, (unsigned char*)&v1[7], v1[2], v1[3], v1[4], v1[5]);
...
int sub_4F54F0(int a1, int a2)
{
    ...
    if (dword_51EDE4 && dword_6B3AD0 == v2) {
        return 1;
    }
...
void sub_4F5720()
{
    ...
    dword_51EDE8 = sub_4F59B0(dword_6B3AD0 >> 2) > -dword_6B3AD0 >> 1 && !dword_51EDEC;
    dword_51EDEC = 0;
    ...
    while (1) {
        ...
        v1 = (stru_6B3668.dwBufferBytes + dword_6B39E0[dword_6B3660] - dword_6B39C8)
        ...
        if (!v2 || !(dwStatus & DSBSTATUS_PLAYING)) {
            if (v0) {
                sub_4F5540(dword_6B3AD0 + (dword_6B3AD0 >> 2));
            }
            ...
            v6 = (stru_6B3668.dwBufferBytes + dword_6B39C8 + v3) % stru_6B3668.dwBufferBytes;
...
void sub_4F5A00(unsigned char* a1, int a2)
{
    ...
    v3 = 1;
    if (dwAudioBytes1 != 0) {
        v2 = sub_4F5B70((unsigned char*)lpvAudioPtr1, &a1, dwAudioBytes1, 0, 1);
        v3 = 0;
        dword_6B36A4 += dwAudioBytes1;
    }

    if (dwAudioBytes2 != 0) {
        sub_4F5B70((unsigned char*)lpvAudioPtr2, &a1, dwAudioBytes2, v2, v3);
...
int sub_4F5B70(unsigned char* dest, unsigned char** src_ptr, int a3, int a4, int a5)
{
    ...
    if (!dword_6B39D8) {
        ...
        result = sub_4F697C(v10, src, v11 >> 1, v9);
        *src_ptr = src + (v11 >> 1);
        return result;
    }
    ...
    result = sub_4F69AD(v13, src, v14 >> 2, v12);
    *src_ptr = src + (v14 >> 1);
...
int sub_4F5CB0(int a1, int a2, int a3, int a4)
{
    ...
    ddsd.dwWidth = dword_6B3CFC;
    ddsd.dwHeight = dword_6B402F;
    ...
    dword_6B4027 = a4;
    dword_6B402B = a3 * dword_6B3CFC - 8;
...
void sub_4F5F40(int a1, int a2, int a3)
{
    ...
    v4 = ((4 * dword_6B3CFC / dword_51EBDC - 12) & 0xFFFFFFF0) + 12;

    dword_6B3CF8 = dword_6B3CFC - dword_51EBDC * (v4 >> 2);

    v3 = a1;
    if (a1 < 0) {
        if (dword_6B4027) {
            v3 = (dword_6B367C - (v4 >> 1)) >> 1;
        } else {
            v3 = (dword_6B367C - v4) >> 1;
        }
    }
    ...
    if (a2 >= 0) {
        ...
        v6 = dword_6B402F;
        if (dword_51EBD8 & 4) {
            v5 = (dword_6B36AC - 2 * dword_6B402F) >> 1;
        } else {
            v5 = (dword_6B36AC - dword_6B402F) >> 1;
        }
    }
    ...
    if (a3) {
        // TODO: Incomplete.
        // sub_4FBE91(off_6B4033, dword_6B3CFC, v6, dword_6B401B, dword_6B401F, dword_6B4017, dword_6B4023, v7, v5, a3);
        ...
        off_51EE08(gMovieDirectDrawSurface1, dword_6B3CFC, v6, 0, dword_6B401F, ((4 * dword_6B3CFC / dword_51EBDC - 12) & 0xFFFFFFF0) + 12, dword_6B4023, v7, v5);
    }
}
...
void sub_4F60F0(int a1, int a2, int a3, int a4, int a5, int a6)
{
    ...
    for (i = 0; i < a2; i++) {
        for (j = 0; j < a3; j++) {
            byte_6B3D0C[3 * a1 + 3 * j] = (63 * i) / (a2 - 1);
            byte_6B3D0C[3 * a1 + 3 * j + 1] = 0;
            byte_6B3D0C[3 * a1 + 3 * j + 2] = 5 * ((63 * j) / (a3 - 1)) / 8;
        }
    }

    for (i = 0; i < a5; i++) {
        for (j = 0; j < a6; j++) {
            byte_6B3D0C[3 * a4 + 3 * j] = 0;
            byte_6B3D0C[3 * a4 + 3 * j + 1] = (63 * i) / (a5 - 1);
            byte_6B3D0C[3 * a1 + 3 * j + 2] = 5 * ((63 * j) / (a6 - 1)) / 8;
        }
    }
}
...
void sub_4F6550(STRUCT_4F6930* a1)
{
    ...
    stru_6B3690.field_4 = a1->field_8.field_4;
    stru_6B3690.field_8 = a1->field_8.field_8;
    off_6B39CC = a1->fileHandle;
    dword_6B369C = a1->field_18;
    ...
    dword_6B3CFC = a1->field_40;
    dword_6B402F = a1->field_44;
...
void sub_4F6610(STRUCT_4F6930* a1)
{
    ...
    ptr->field_0 = stru_6B3690.field_0;
    ptr->field_4 = stru_6B3690.field_4;
    ptr->field_8 = stru_6B3690.field_8;
    a1->fileHandle = off_6B39CC;
    a1->field_18 = dword_6B369C;
    ...
    a1->field_40 = dword_6B3CFC;
    a1->field_44 = dword_6B402F;
...
// 0x4F7359
void sub_4F7359(unsigned char* a1, unsigned char* a2, int a3, int a4, int a5, int a6)
{
    int v49;
    unsigned char* dest;
    int v8;
    ...
    if (a3 || a4) {
        dest = gMovieDirectDrawSurfaceBuffer1 + dword_6B401B + dword_6B3CFC * dword_6B401F;
    }
            ...
            for (j = 0; j < 2; j++) {
                ...
                case 12:
                    ...
                    for (i = 0; i < 4; i++) {
                        ...
                        dest_ptr = (unsigned int*)(dest + dword_6B3CFC);
                        dest_ptr[0] = value1;
                        dest_ptr[1] = value2;
