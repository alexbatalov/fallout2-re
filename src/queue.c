...
EventTypeDescription gEventTypeDescriptions[EVENT_TYPE_COUNT] = {
    { drugEffectEventProcess, internal_free, drugEffectEventRead, drugEffectEventWrite, true, sub_47A178 },
    { knockoutEventProcess, NULL, NULL, NULL, true, sub_42E460 },
    { withdrawalEventProcess, internal_free, withdrawalEventRead, withdrawalEventWrite, true, sub_47A2FC },
    ...
    { explosionEventProcess, NULL, NULL, NULL, true, sub_4A2830 },
    { miscItemTrickleEventProcess, NULL, NULL, NULL, true, sub_479954 },
    { sneakEventProcess, NULL, NULL, NULL, true, sub_42E3E4 },
    { explosionFailureEventProcess, NULL, NULL, NULL, true, sub_4A2830 },
...
// 0x4A2790
void sub_4A2790(int eventType, QueueEventHandler* fn)
{
...
// 0x4A2830
int sub_4A2830(Object* obj, void* data)
{
...
void sub_4A2920()
{
    for (int eventType = 0; eventType < EVENT_TYPE_COUNT; eventType++) {
        ...
        if (eventTypeDescription->field_10) {
            sub_4A2790(eventType, eventTypeDescription->field_14);
        }
    }
}
